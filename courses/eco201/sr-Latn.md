...
Počećemo sa opštim uvodom u austrijsku ekonomiju, istražujući njeno istorijsko poreklo i osnove njenog mišljenja. Ovaj deo takođe pokriva osnovne pojmove kao što su novac, kredit, banke i centralne banke. Razumećete zašto ove institucije igraju centralnu ulogu u austrijskom mišljenju, posebno u njihovoj kritici monetarnih intervencija.


**Sekcija 2: Teorijske Osnove**

Ovaj deo će se upustiti u osnovne pojmove austrijske ekonomije, kao što je subjektivna teorija vrednosti, koja objašnjava zašto vrednost dobra nije objektivna već zavisi od percipirane korisnosti od strane svakog pojedinca. Takođe ćete otkriti kako novac prirodno nastaje kao društveni fenomen, zajedno sa konceptima vremenske preferencije, kamate i kapitala koji su u srcu austrijske teorije slobodnog tržišta.


**Sekcija 3: Austrijske ekonomske perspektive**
...
> Carl Menger, Principi političke ekonomije


### Marginalna revolucija


U korenu ekonomskog razmišljanja leži pitanje vrednosti. Kako određujemo vrednost nečega? Da li je vrednost inherentno svojstvo stvari? Ili je, naprotiv, subjektivni fenomen? Kako upoređujemo vrednost dve stvari? Odakle dolazi vrednost?
...
Prema ovom gledištu, litar pijaće vode nema objektivnu vrednost. Osoba koja ima pristup modernom sistemu pijaće vode i trenutno nije žedna verovatno bi dodelila vrlo malu vrednost tom dodatnom litru vode, dok bi pojedinac koji je žedan usred pustinje, videći ga kao razliku između života i smrti, sigurno bio spreman da pripiše gotovo beskonačnu vrednost tom litru vode.
...
Svi su jedinstveni i imaju određenu ličnu situaciju. Stoga, svako poseduje superiornu sposobnost da obavlja određene zadatke bolje od svojih vršnjaka (apsolutna prednost) ili superiornu sposobnost da obavlja određene zadatke bolje od drugih (komparativna prednost). Ne može biti drugačije; negirati ovu elementarnu činjenicu značilo bi tvrditi da su svi ljudi jednaki u svim aspektima.
...
> "Ako čovek vidi da može živeti udobnije viseći sa vešala nego sedeći za stolom, ponašao bi se kao budala ako se ne bi obesio."
>
...
Međutim, kada se radi o većim zajednicama koje značajno profitiraju od podele rada, problemi koordinacije ponovo se javljaju. To je zbog dva glavna razloga:
...
Postupajući na ovaj način, Robinson pravi proizvodni zaokret: umesto da direktno sakuplja bobice, ulaže napor u proizvodnju kapitalnog dobra koje će ga učiniti produktivnijim u budućnosti. Međutim, mora napraviti kratkoročnu žrtvu, tj. štedeti, da bi to postigao. Ako to ne bi učinio, ne bi bio u stanju da završi svoje kapitalno dobro. Ova kratkoročna žrtva, međutim, pruža mu značajnu prednost jer, kada je opremljen svojim štapom, dobija 4 sata dnevno (dok štap ne postane zastareo). Ova 4 dodatna sata dnevno omogućavaju mu da stvori više kapitalnih dobara, kao što su alati za lov ili ribarske mreže, postepeno poboljšavajući svoju situaciju.


### Zaključak


Drugim rečima, u ekonomiji jednog čoveka Robinzona Krusoa, štednja kroz žrtvovanje trenutnog zadovoljstva je ono što akumulira kapital koji povećava produktivnost. U ovom kontekstu, štednja, tj. odlaganje trenutnog zadovoljstva, je cena koju treba platiti za povećano buduće zadovoljstvo. To znači da je, u ovom kontekstu, štednja preduslov i neophodan uslov za bilo kakav ekonomski razvoj.
...
Bio je to Ludwig Von Mises, najuspešniji učenik Böhm-Bawerka i verovatno najvažniji austrijski ekonomista 20. veka, koji je koristio Böhm-Bawerkovo rezonovanje o kapitalu da objasni uzroke i dinamiku ekonomskih ciklusa. Friedrich A. Hayek, Misesov štićenik, kasnije je proširio ovo rezonovanje do njegovih logičkih zaključaka u radovima za koje je 1974. godine dobio Nobelovu nagradu za ekonomiju.


Mises i Hayek su započeli svoju analizu sa povećanjem štednje kao početnom tačkom. Kao što smo videli u prethodnim poglavljima, svako povećanje štednje nužno podrazumeva odgovarajuće smanjenje potrošnje i time niže relativne cene potrošačkih dobara. To dovodi do dva efekta: prvo, povećana potražnja za kapitalnim dobrima uzrokovana rastom realnih plata kao rezultat relativnog smanjenja cena potrošačkih dobara; i drugo, povećanje preduzetničkih profita na fazama proizvodnje najudaljenijim od potrošnje (nižeg reda). Kako realne plate rastu, preduzetnici su motivisani da štede rad koristeći više kapitalnih dobara, što stvara jaču potražnju za kapitalnim dobrima i veće profite za preduzetnike koji proizvode ova dobra nižeg reda. Dakle, u kontekstu povećane štednje, tj. smanjenja vremenskih preferencija, kamatne stope padaju, podstičući razvoj dodatnih faza proizvodnje i povećanu produktivnost. Ovo je klasičan Böhm-Bawerkov proizvodni zaobilazni put i to je veoma poželjan ishod.


Međutim, dva austrijska ekonomista su razmatrala šta bi se desilo ako smanjenje kamatne stope, koje služi kao početna tačka za ovo skretanje u proizvodnji, ne bi bilo rezultat povećanja štednje već umesto toga ekspanzije kredita.


U kontekstu frakcionalnog bankarstva, ekspanzija kredita ne zahteva odgovarajuće povećanje štednje. Stoga, preduzetnici mogu prikupiti više kapitala i upustiti se u zaobilazne puteve proizvodnje čak i kada vremenske preferencije ostanu nepromenjene, tj. bez smanjenja potrošnje. Za Hajecka i Mizesa, takva situacija nužno bi trebala dovesti do značajnih problema koordinacije među ekonomskim agentima. Zbog nedostatka kamatnih stopa slobodnog tržišta, ovi problemi možda neće biti odmah očigledni, ali na duži rok, rezultirajuće pogrešne alokacije kapitala trebale bi proizvesti opipljive posledice: recesiju.


Da bismo što jasnije opisali ovaj fenomen vremenske nekoordinacije i njegove posledice, oslanjaćemo se na model strukture proizvodnje i posmatrati kako je ona pogođena, prvo smanjenjem kamatnih stopa koje proizilazi iz povećanja štednje, a zatim smanjenjem kamatnih stopa uzrokovanim ekspanzijom kredita.


### Smanjenje kamatnih stopa zbog povećanja štednje:
...
Ako, na agregatnom nivou, ekonomski agenti povećaju svoju štednju, količina konačnih dobara koja se konzumira će se smanjiti - sve ostalo ostaje jednako, štednja nužno podrazumeva odlaganje dela potrošnje za kasniji datum. Kao rezultat, kamatne stope će pasti - jer Supply kapitala raste, omogućavajući preduzetnicima da iskoriste ovaj priliv kapitala za stvaranje novih investicionih dobara i tako produže strukturu proizvodnje.
...
Takođe je vredno napomenuti da će smanjenje potražnje za potrošačkom robom uzrokovati, na srednji rok, smanjenje cena potrošačkih proizvoda, a ne smanjenje količine ponuđene finalne robe. To je zato što se završni deo proizvodne strukture neće odmah prilagoditi nakon što dođe do pada potražnje za potrošačkom robom; preduzetnicima će biti potrebno neko vreme da promene svoje planove i investicije. Kako drže zalihe, smanjenje potražnje će ih primorati da te zalihe prodaju uz popust, i, kao posledica toga, višak štednje će u početku rezultirati nižim cenama potrošačkih proizvoda (tj. povećanjem realnih plata).


Suprotno tome, cene investicione robe će porasti jer prenos kupovne moći na preduzetnike omogućava im da povećaju svoje investicione izdatke. Kada ovu štednju, koju štediše prenesu na preduzetnike, potroše ovi drugi, kamatne stope će ponovo težiti rastu (zbog smanjenog Supply kapitala), što će zauzvrat dovesti do nižih cena investicione robe. Zapravo, na kraju ovog proizvodnog zaobilaznog puta, relativne cene će ostati otprilike iste kao pre. Ali ekonomski subjekti u celini su imali koristi: povećana produktivnost koja proizlazi iz produženja proizvodne strukture ponudiće potrošačima više proizvoda po nižim jediničnim cenama; kupovna moć štediša će se povećati, delimično kroz kamatne prihode, a delimično zbog nižih cena potrošačkih proizvoda; u međuvremenu, preduzetnici, posmatrani kao celina, neće doživeti ni dobitke ni gubitke. Oni koji su angažovani u aktivnostima najbližim potrošnji izgubiće prihod, dok će oni koji su uključeni u stvaranje novih faza proizvodnje proporcionalno dobiti. U takvoj situaciji, ne stvara se novi monetarni prihod; povećava se proizvodnja, i tako realna vrednost prihoda raste.


### Smanjenje Kamata Zbog Povećanja Kredita (Bez Povećanja Štednje):


Sada, ako uzmemo u obzir smanjenje kamatnih stopa koje proizlazi iz proširenja kredita koje nude banke, dobijamo sasvim drugačiju sliku strukture proizvodnje.


Sa nižim kamatnim stopama, preduzetnici mogu pozajmiti više resursa i tako stvoriti više proizvodnih faza višeg reda. U ovom slučaju, takvo proširenje proizvodne strukture neće rezultirati smanjenom potrošnjom jer nije došlo do odlaganja trenutne potrošnje od strane potrošača. Drugim rečima, BDP raste. Posledično, naš trougao će se produžiti dok će zadržati sličnu visinu, što znači da će se njegova površina povećati.
...
Sada, preduzetnici uključeni u ove više faze proizvodnje ostvaruju veće monetarne prihode, i, kako je vremenska preferencija ostala ista, trebalo bi da vidimo i povećanu potražnju za potrošačkim proizvodima. Ali kako je, tokom ovog buma, relativna profitabilnost uloženog kapitala bila veća u sektorima daleko od potrošnje, došlo je do prenosa resursa iz aktivnosti bliskih potrošnji ka udaljenijim aktivnostima. Posledično, preduzetnici u nižim fazama proizvodnje nemaju resurse da zadovolje povećanu potražnju. Ovo stvara tenziju između ova dva dela strukture proizvodnje: svaki pokušava da dobije kapital na račun drugog, i pošto potražnja za potrošnjom predstavlja hitnije potrebe, u nekom trenutku, preduzetnici angažovani u aktivnostima udaljenim od potrošnje će ostati bez resursa potrebnih za dovršavanje svojih investicija. Tada stopa profita u ovim sektorima počinje da opada, preduzeća bankrotiraju, a relativno povećanje cena potrošača motiviše brzu realokaciju kapitala ka proizvodnji dobara nižeg reda. Kada se ova iznenadna realokacija resursa manifestuje, ekonomija ulazi u recesiju: cene imovine padaju, realne plate opadaju, cene potrošača padaju, a zalihe se gomilaju.


Za Friedricha Hayeka i Ludviga fon Mizesa, recesija je manifestacija pogrešne alokacije kapitala iz faze ekspanzije. Kako su cene štednje i kapitala bile manipulirane, preduzetnici su razvijali projekte koji nisu mogli biti završeni zbog nedostatka resursa, i/ili su gradili proizvodne kapacitete planirajući za budući nivo potrošnje koji nije mogao biti održiv zbog nedostatka štednje.


Samo kroz deflaciju, tj. pad cena imovine i cena rada, više kamatne stope i likvidaciju nezavršenih projekata, ekonomija može da se prilagodi i razvija ka održivom putu. Dakle, recesija je raspršivanje ove iluzije prosperiteta koja pokreće nasilni proces prilagođavanja.


Uopšteno, recesiju pokreće sam bankarski sektor. Sve dok kredit raste ubrzanim tempom, cene nastavljaju da rastu, a preduzetnici se takmiče za produktivne resurse. Međutim, kako je primetio Hyman Minsky, dolazi trenutak kada bankarski sektor odluči da smanji svoj rizik, te smanjuje tok kredita. Depresija, dakle, rezultira mnogim bankrotstvima, stezanjem kredita, smanjenjem dostupne kupovne moći i finansijskim kolapsima.


Takvo prilagođavanje može se posmatrati kao period tokom kojeg su podpotrošnja i podinvestiranje nametnuti kako bi se obnovile nedostajuće uštede. Za Haje ka, ova depresivna faza, iako bolna, je veoma neophodna jer omogućava oporavak ekonomske aktivnosti zasnovan na strukturi relativnih cena koje odražavaju stvarnu oskudicu proizvodnih faktora. Ako se ova depresija prekine, ekonomija ne može da se vrati na poželjnu putanju jer, u odsustvu informacionog sistema koji omogućava ekonomskim agentima da racionalizuju svoje odluke, pogrešna alokacija resursa će se samo nastaviti.
...
U modernoj eri, centralne banke i vlade su bile toliko revnosne u sprečavanju manifestacije ovog procesa prilagođavanja da završavamo sa masovnom strukturnom nezaposlenošću i stalnim nagomilavanjem duga. Japan služi kao primer u tom pogledu. Nakon pucanja balona imovine 1989-90, Banka Japana (BoJ) i razne vlade na vlasti koristile su sve ovde opisane metode kako bi pokušale da "ponovo pokrenu japansku ekonomiju." Osim kratkih skokova nakon programa potrošnje i smanjenja kamatnih stopa, Japan je ostao u stanju neurasteničnog rasta i prekomerne zaduženosti već 30 godina.


### Zaključak o teoriji poslovnog ciklusa:


Ističući sekvencijalnu prirodu ljudske akcije i posvećujući posebnu pažnju uticaju fluktuacija kamatnih stopa na intertemporalnu koordinaciju ekonomskih agenata, Ludwig Von Mises i Friedrich Hayek su objasnili ekonomske cikluse kao endogene dinamike sistema bankarstva sa delimičnim rezervama. Razlika između austrijske analize i one monetarista i kejnzijanaca uglavnom leži u činjenici da prvi posvećuju posebnu pažnju različitim fazama proizvodnje i strukturi relativnih cena, dok se drugi zaustavljaju na agregiranim varijablama kao što su nivoi zaposlenosti, BDP ili indeks potrošačkih cena. Zaista, kako im nedostaje teorija kapitala, mejnstrim ekonomisti imaju tendenciju da uzroke recesije pripisuju "životinjskim duhovima" ili "spoljnim događajima".


Više nego bilo koja druga škola ekonomije, Austrijska škola insistira na važnosti relativnih cena za koordinaciju ekonomskih agenata. Članovi Austrijske škole su uvučeni u debate o ovoj temi više od jednog veka, posebno od kada je Mises objavio svoje delo o nemogućnosti ekonomske kalkulacije u socijalističkim ekonomijama 1919. godine.


Ovo će biti tema sledećeg i poslednjeg poglavlja ovog kursa.
...
> Ludwig von Mises, Planirani Haos


### Nemogućnost ekonomske kalkulacije pod socijalizmom


Uprkos ponovljenim neuspesima marksističkih režima tokom prošlog veka, debata o ekonomskoj kalkulaciji ostaje relevantna iz dva značajna razloga:


1. Uporedive ideje i dalje zagovaraju progresivci i drugi intervencionisti.

2. Fiksiranje cena, bilo na tržištima kapitala kroz akcije centralnih bankara ili na drugim tržištima putem državnih preduzeća, dekreta i intervencije regulatornih komiteta, i dalje je rasprostranjeno.


### Debata o ekonomskoj kalkulaciji


Ova debata je prvobitno pokrenuta jednim od najuticajnijih ekonomskih radova 20. veka, "Ekonomska kalkulacija u socijalističkoj zajednici," čiji je autor Ludvig fon Mizes, a objavljen je 1920. godine. Tokom tog perioda, socijalizam je bio u usponu, sa boljševicima koji su preuzeli vlast u Rusiji, socijalistima koji su zauzeli položaje u Vajmarskoj Republici (Nemačka), i socijalističkim i komunističkim partijama koje su sticale značaj širom Evrope.


Pre Misesovog članka, debate o socijalizmu i kapitalizmu su se prvenstveno vrtile oko moralnih argumenata i problema podsticaja. Čak i ako bi se pretpostavilo da je društvo organizovano oko marksističkog principa "od svakog prema njegovim sposobnostima, svakome prema njegovim potrebama" moralno superiorno, praktično pitanje "ko će izneti smeće" i dalje je trebalo rešiti. Uobičajen odgovor je bio da će socijalizam proizvesti pojedince lišene kapitalističkih instinkta, koji će dobrovoljno služiti svojim bližnjima čak i u odsustvu novčanih podsticaja.


Svojim člankom, Mises je uveo novu dimenziju u debatu. Ostavivši po strani utopijske ideje o sposobnosti političke ekonomije da stvori "novog čoveka", austrijski ekonomista je istakao da je racionalna ekonomska organizacija nemoguća bez cena za posredne faktore proizvodnje. Čak i danas, njegov argument ostaje slabo shvaćen od strane njegovih kritičara, pa čak i nekih liberalnih ekonomista. Stoga, vredi ga objasniti detaljnije.
...
Većina zabluda o Misesovim argumentima proizlazi iz pogrešnog shvatanja uloga koje igraju menadžerske i preduzetničke klase u kapitalističkoj ekonomiji. Mises nikada nije odbacio sposobnost menadžera da osmisle efikasne planove proizvodnje unutar svojih operacija. Umesto toga, naglašavao je značaj preduzetnika i akcionara, koji, kao vlasnici sredstava za proizvodnju, raspoređuju kapital kroz različite industrije, čime formiraju cene koje služe kao ulazi u ekonomske kalkulacije menadžera.


Bez tržišta za kapital i novac, postaje nemoguće racionalizovati upotrebu resursa kroz industrije. To znači da čak i ako postoji savršena organizacija unutar svake firme ili dela ekonomije, cela ekonomija ne može efikasno da se prilagodi promenama u dostupnosti resursa, uslovima proizvodnje i preferencijama potrošača. Rečima Misesa:


> "[...] kardinalna zabluda implicirana u [tržišno socijalističkim] predlozima je da oni posmatraju ekonomski problem iz perspektive podređenog činovnika čiji intelektualni horizont ne prelazi granice podređenih zadataka. Oni smatraju strukturu industrijske proizvodnje i alokaciju kapitala u razne grane i proizvodne agregate kao rigidne i ne uzimaju u obzir neophodnost promene ove strukture kako bi se prilagodila promenama uslova.... Ne shvataju da se operacije korporativnih službenika sastoje samo u lojalnom izvršavanju zadataka poverenih od strane njihovih šefova, akcionara.... Operacije menadžera, njihova kupovina i prodaja, samo su mali segment ukupnosti tržišnih operacija. Tržište kapitalističkog društva takođe obavlja one operacije koje alociraju kapitalna dobra u razne grane industrije. Preduzetnici i kapitalisti osnivaju korporacije i druge firme, povećavaju ili smanjuju njihovu veličinu, raspuštaju ih ili spajaju sa drugim preduzećima; kupuju i prodaju akcije i obveznice već postojećih i novih korporacija; odobravaju, povlače i povraćaju kredite; ukratko, obavljaju sve one radnje, čija se ukupnost naziva tržište kapitala i novca. Upravo te finansijske transakcije promotera i špekulanata usmeravaju proizvodnju u one kanale u kojima ona na najbolji mogući način zadovoljava najhitnije potrebe potrošača."
>

> Mises, Human Action, str. 703-04


U suštini, Mises tvrdi da prava vlasništva, koja postavljaju vlasnike kapitala u kontekst profita i gubitaka, motivišu ih da alociraju svoje resurse u industrije koje trenutno najviše trebaju resurse kako bi zadovoljile potražnju potrošača. Kada uspeju, ostvaruju profit, ali kada ne uspeju, trpe finansijske gubitke. Njihova "koža u igri" ih podstiče da spekulišu o najboljoj alokaciji kapitala za trenutno stanje ekonomije. Ovo stvara tržišno vođenu dinamiku gde kolektivni ishodi njihovih akcija proizvode vitalne informacije o najefikasnijem korišćenju resursa.


Prethodna poglavlja su objasnila da su vrednosti subjektivne, ekonomske akcije otkrivaju oportunitetne troškove, a potrošačke cene izražavaju ordinalnu hijerarhiju potrošačkih želja. Preduzetnici se takmiče za faktore proizvodnje kako bi konstruisali proizvodne strukture koje maksimiziraju prihode u odnosu na troškove, zadovoljavajući potrošačke želje efikasnije od alternativnih opcija. Stoga, cene faktora proizvodnje su izvedene iz potrošačkih cena: ako faktor proizvodnje može generate veći monetarni prihod (bolje zadovoljavajući potrošačke želje) u drugoj industriji ili pod drugačijim planom, preduzetnici će nadmašiti trenutnog vlasnika, podižući njegovu cenu do njegove marginalne produktivnosti. Ovo takmičenje među preduzetnicima za faktore proizvodnje, određujući njihov najveći marginalni prinos, je proces koji generiše relevantne informacije o alokaciji resursa.


Ovaj proces je ključan jer potvrđuje ili opovrgava efikasnost različitih aktivnosti, osiguravajući da su faktori proizvodnje raspoređeni na najproduktivnije načine. Tržište obavlja ovu funkciju kao kontinuirani proces. U svetu koji se stalno menja—gde su potrošačke preferencije, uslovi proizvodnje, tehnologija, regulative, demografija i još mnogo toga u stalnom toku—cene za posredne faktore proizvodnje neprestano se menjaju kroz akcije preduzetnika i kapitalista koji se prilagođavaju promenljivim uslovima. Pošto su ove promene lokalizovane, informacije moraju biti distribuirane ekonomskim agentima koji ne mogu imati potpuno znanje o celom svetu. Ovo je uloga tržišta: omogućava preduzetnicima da deluju na osnovu lokalizovanih, često kvalitativnih i složenih informacija predlažući ekonomske strukture proizvodnje koje tržište zatim potvrđuje ili opovrgava. Na ovaj način, relevantne informacije generisane ovim procesom odozdo nagore kondenzuju se i distribuiraju kroz celu ekonomiju putem sistema cena. Ovaj proces proizvodnje i distribucije informacija je suštinski za alokaciju resursa jer omogućava ekonomskim agentima, koji imaju ograničeno znanje o svetu, da vrše ekonomske kalkulacije i osmišljavaju koherentne ekonomske planove oslanjajući se na cene.


Iz ove perspektive, centralno planirana ekonomija će neizbežno iskusiti pogrešnu alokaciju kapitala. U kratkom do srednjem roku, takve pogrešne alokacije mogu proći neprimećeno jer ne postoje tržišne cene ili bankroti koji bi ih otkrili. Međutim, zbog odsustva povratnih informacija (cena) i mehanizama preraspodele (bankroti), greške će se akumulirati dok rasipništvo ne postane očigledno kroz značajan pad životnih uslova.


![image](assets/en/22.webp)


### Austrijska perspektiva i neuspesi drugih škola ekonomije


Moglo bi se tvrditi da je lako slikati takvu panoramu unazad. Uostalom, svi smo svesni praznih polica u SSSR-u, teškoća u Venecueli i humanitarne katastrofe u Kambodži. Ali Mises je predvideo ove događaje još 1920. godine. Ipak, sve do kolapsa SSSR-a 1989. godine, mnogi ekonomisti, uključujući brojne dobitnike Nobelove nagrade, hvalili su sovjetsko ekonomsko čudo i predviđali da će sovjetska ekonomija uskoro nadmašiti ekonomiju SAD-a.


Uprkos ovom impresivnom predviđanju i brojnim empirijskim demonstracijama nemogućnosti ekonomske kalkulacije pod socijalizmom, politički lideri širom sveta su više nego ikada željni da postavljaju cene, nacionalizuju čitave industrije i predlažu petogodišnje planove, često uz aplauz ekonomski neinformisanih populacija. Posledice takvog intervencionizma oštro osećaju ljudi u nekada prosperitetnim zapadnim zemljama koji polako svedoče opadanju svog životnog standarda.
...
U prethodnom poglavlju, objasnili smo dinamiku prekomernog ulaganja i pogrešne alokacije kapitala koja proizlazi iz manipulacije kamatnim stopama od strane centralnih banaka. U suštini, ono što smo objasnili može se posmatrati kao specifičan slučaj nemogućnosti ekonomske kalkulacije pod socijalizmom, primenjen na oblast tržišta novca. Kada su cene fiksirane izvan njihovih tržišnih vrednosti, preduzetnici i alokatori kapitala su podstaknuti da se upuste u investicije koje ne mogu biti održive na duži rok zbog nedostatka štednje. Mešanjem u sistem cena, centralni planeri (u ovom slučaju, centralni bankari) stvaraju nekoordinaciju između ekonomskih agenata. U ovom slučaju, međuvremenska nekoordinacija podrazumeva prekomerno ulaganje u investicione robe višeg reda i nedovoljno ulaganje u investicione robe nižeg reda, što predstavlja specifičnu manifestaciju pogrešne alokacije kapitala kroz industrije.


Posledice takve pogrešne alokacije uključuju finansijske i ekonomske krize, smanjenu ekonomsku aktivnost i deflaciju duga. Ovi makroekonomski efekti proizlaze iz neravnoteže između štednje i investicija usled ekspanzije kredita. U SSSR-u i drugim komunističkim režimima, fiksiranje cena dovelo je do slične nekoordinacije, što je rezultiralo nestašicama nekih dobara i prekomernom proizvodnjom drugih. U oba slučaja, cene ne odražavaju istinske preferencije potrošača, bilo u smislu vremenskih preferencija ili preferencija potrošnje, što dovodi preduzetnike ili centralne planere odgovorne za alokaciju resursa da investiraju kapital u "pogrešne industrije."


Danas se debata o ekonomskoj kalkulaciji ponovo pojavljuje prvenstveno u diskusijama o energiji, gde su pogrešne investicije vođene Green agendom sve očiglednije. Takođe se javlja u diskusijama o tržištima novca, gde austrijski ekonomisti ističu da je kriza iz 2008. godine, koju glavni ekonomisti nisu uspeli da predvide, bila klasičan ciklus buma i kraha karakterisan prekomernim ulaganjima u tržište nekretnina zbog dugih perioda niskih kamatnih stopa. Štaviše, neo-marksisti i druge socijalističke frakcije šire ideju da bi pojava veštačke inteligencije mogla rešiti problem ekonomske kalkulacije. Međutim, ova perspektiva proizlazi iz pogrešnog razumevanja problema; problem ekonomske kalkulacije nije pitanje računarske snage već pitanje generisanja i distribucije informacija vezanih za proizvodnju i alokaciju resursa. Ove informacije mogu biti generisane samo lokalno od strane agenata sa specijalizovanim znanjem i interesom u ishodu. Veštačka inteligencija ne može zameniti ovaj proces odozdo prema gore i stoga ne može pomoći centralnim planerima da Address problem alokacije resursa. Nažalost, zbog jednog veka nerazumevanja, očekujemo proliferaciju tvrdnji da će veštačka inteligencija doneti novu eru ekonomske prosperiteta predvođenu prosvetljenim centralnim planerima koji, uz pomoć veštačke inteligencije, mogu ispraviti neuspehe slobodnih tržišta.


Za konkretnu primenu problema ekonomskog obračuna na savremenu situaciju, možete se obratiti ovom članku koji se bavi problemom raspodele resursa u modernoj Kini.
...
U ovom završnom poglavlju istražili smo nemogućnost ekonomske kalkulacije pod socijalizmom, što je centralni princip austrijske škole ekonomije. Austrijska perspektiva predstavljena u ovom kursu kulminira ovim zaključkom i pruža snažan argument za politike neintervencionizma. U svojoj srži, sva austrijska razmišljanja se vrte oko važnosti cena u ekonomskoj koordinaciji. Naglašavajući značaj oportunitetnih troškova i ekonomske kalkulacije za racionalno korišćenje resursa, austrijski ekonomisti pokazuju složenost i suptilnost ljudskog delovanja u svetu koji se neprestano menja.


Mainstream ekonomisti i centralni planeri često ne vole austrijske ekonomiste jer oni ističu neizvesnost budućnosti, zabludu kvantitativnog ekonomskog predviđanja i štetne efekte ekonomske intervencije. Ukratko, austrijska ekonomija naglašava neefikasnost i štetne posledice intervencionističkih akcija.


Austrijska tradicija utelovljuje skroman pristup ljudskom delovanju, izvlačeći duboke implikacije iz pojmova subjektivne vrednosti, neizvesnosti, slobodne volje i složenosti. Objašnjava kako tržišni poredak, iako nije proizvod ljudskog dizajna, stoji kao centralna institucija za naš razvoj i prosperitet. Ako postoji jedna ključna pouka iz ovog kursa, to je da je kapitalizam postao dominantni ekonomski sistem zbog svoje sposobnosti da se prilagodi promenama u dinamičnom i neizvesnom svetu naseljenom slobodnim pojedincima.
...
Austrijska škola ekonomije razlikuje se od drugih škola po svojoj aksiomatsko-deduktivnoj metodologiji, koja se razlikuje od pozitivističkog pristupa često korišćenog u društvenim naukama. Pozitivistički pristup zasniva se na zakonima uspostavljenim iz empirijskih podataka, usvajajući metodu sličnu onoj u fizičkim naukama. Formuliše hipoteze iz posmatranja, koje se zatim potvrđuju ili opovrgavaju privremenim eksperimentima. Naučni metod se sastoji od zadržavanja hipoteze koja najbolje objašnjava podatke i nastavljanja njenog istraživanja dok se ne pronađe preciznija hipoteza.


Međutim, u društvenim naukama je teško izolovati varijable kao u fizici, jer je svaki trenutak u istoriji jedinstven i mnoštvo faktora dolazi u igru. Ekonomski eksperimenti ne mogu se reprodukovati u laboratoriji, i važno je napomenuti da posmatranje korelacije između dve varijable ne dokazuje uzročnu vezu između njih. Austrijanci, posebno Ludwig von Mises, predložili su alternativnu metodu nazvanu apriorna ili aksiomatsko-deduktivna metoda za proučavanje društvenih nauka. Ovaj pristup zasniva se na fundamentalnim tvrdnjama nazvanim aksiomi, sličnim onima koji se koriste u matematici. Na primer, Euklidska geometrija je primer aksiomatsko-deduktivne metode u oblasti matematike.


U austrijskoj ekonomiji, fundamentalni aksiomi uključuju pozitivne vremenske preferencije, koje se zasnivaju na individualnim izborima dobara ili usluga danas, a ne sutra, zbog neizvesnosti o budućnosti. Ovi aksiomi se ne dovode u pitanje, jer se smatraju očiglednim i konzistentnim sa svakodnevnim životom. Koristeći ove osnovne aksiome, austrijski ekonomisti koriste pravila logike da izvedu izjave koje pružaju informacije o funkcionisanju ekonomskih fenomena. Na primer, oni objašnjavaju da su ekonomske krize uzrokovane neravnotežom između štednje i investicija, što dovodi do veštačke manipulacije kamatnim stopama. Pojedinci sa pozitivnim vremenskim preferencijama zahtevaju pozitivnu kamatnu stopu kao kompenzaciju za rizik pozajmljivanja. Austrijanci tvrde da su odnosi vrednovanja subjektivni, pa kamatne stope mogu varirati u zavisnosti od pojedinaca i okolnosti.


Cene igraju ključnu ulogu u racionalnoj organizaciji pojedinaca sa delimičnim informacijama. Kamatna stopa balansira Supply i potražnju kapitala na tržištu, čime se podstiče ekonomija. Austrijski ekonomisti naglašavaju da proizvoljno postavljanje kamatne stope može dovesti do ekonomskih kriza i učiniti kalkulaciju nemogućom u socijalističkom režimu.


### Austrijski ekonomisti i metodološke razlike


Austrijski ekonomisti često nailaze na poteškoće prilikom rasprave sa drugim školama mišljenja, jer ne koriste iste metode analize. Dok Austrijanci zaključuju iz osnovnih aksioma, kao što je subjektivnost vrednosti, kako bi izveli logične posledice, kejnzijanski ili monetaristički ekonomisti obično se oslanjaju na empirijske podatke kako bi uspostavili opšte ekonomske zakone.


Primer metodološke razlike je stav zagovornika moderne monetarne teorije (MMT) koji su se zalagali za štampanje novca kako bi postigli političke ciljeve, koristeći odsustvo inflacije između 2008. i 2019. kao argument. Austrijski ekonomisti i zagovornici MMT-a ne govore istim jezikom i ne slažu se oko kriterijuma za određivanje validnosti ekonomskog zakona. Ovo čini debate između ovih različitih škola teškim i često neproduktivnim.


Važno je napomenuti da biranje podataka, koje podrazumeva selektivno odabiranje podataka za uspostavljanje odnosa između varijabli, predstavlja nenačinu i nerigoroznu metodu u ekonomiji. Kreiranje novca, na primer, ne uzrokuje nužno inflaciju, i potreban je nijansiraniji pristup za razumevanje složenih ekonomskih mehanizama. Aksiomi igraju ključnu ulogu u austrijskom ekonomskom razmišljanju. Oni su fundamentalni Elements iz kojih se mogu izvesti logički zaključci. Međutim, važno je prepoznati da je precizno predviđanje budućnosti u ekonomiji često teško zbog složenosti ekonomskih fenomena i inherentne neizvesnosti.


Metodologija je suštinski aspekt u ekonomiji i u društvenim naukama uopšte. Ona utiče na to kako se postavljaju pitanja, kako se formulišu hipoteze i kako se tumače podaci. Razumevanje metodoloških razlika između ekonomskih škola mišljenja može nam pomoći da cenimo različite perspektive i razvijemo sopstvena mišljenja o temama koje su diskutovane u prethodnim epizodama.
